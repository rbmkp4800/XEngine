...
void SwapChain::updateRTVs(bool allocateDescriptors)
{
...
void SwapChain::initialize(Device& device, void* hWnd, uint16x2 size)
{
	this->device = &device;
...
void SwapChain::resize(uint16x2 size)
{
...
void SwapChain::present(bool waitVSync)
{
	dxgiSwapChain->Present(waitVSync ? 1 : 0, 0);
}

Target& SwapChain::getCurrentTarget()
{
