...
namespace XEngine
{
	...
	struct XEColor
	{
		...
		constexpr inline XEColor() : rgba(0) {}
		constexpr inline XEColor(uint32 _rgba) : rgba(_rgba) {}
		constexpr inline XEColor(uint8 _r, uint8 _g, uint8 _b, uint8 _a) : r(_r), g(_g), b(_b), a(_a) {}
